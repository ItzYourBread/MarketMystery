            ...
            switch (_a.label) {
                ...
                case 3:
                    ...
                    insufficientShares = {
                        ...
                        description: "You attempted to sell `".concat(amount.toLocaleString(), "` shares of **").concat(ticker, "**, but you only own `").concat(Data.stock[ticker].shares.toLocaleString(), "` shares. Please try again with a lower amount."),
                        fields: [
                            {
                                name: 'Total Shares Owned',
                                value: "`".concat(Data.stock[ticker].shares.toLocaleString(), "` "),
                                inline: true,
                            },
                            {
                                name: 'Attempted Sale',
                                value: "`".concat(amount.toLocaleString(), "` shares of ").concat(ticker),
                                inline: true,
                            },
                        ],
                        timestamp: new Date(),
